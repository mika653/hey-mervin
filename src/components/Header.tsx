    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-10">
          ...
          <a
            href="#cta"
            className="text-base font-medium px-7 py-3 rounded-full bg-accent hover:bg-accent-light text-white whitespace-nowrap transition-all duration-300 hover:shadow-lg hover:shadow-accent/25"
          >
            Book a Call
          </a>
        </nav>
      ...
      >
        <nav className="flex flex-col items-center gap-8 py-10 bg-bg/95 backdrop-blur-xl border-b border-border-subtle">
          ...
          <a
            href="#cta"
            onClick={() => setMobileOpen(false)}
            className="text-base font-medium px-8 py-4 rounded-full bg-accent hover:bg-accent-light text-white whitespace-nowrap transition-all duration-300"
          >
            Book a Call
          </a>
        </nav>
